<%@ WebHandler Language="C#" Class="getIncomeList " %>
...
public class getIncomeList : IHttpHandler, IRequiresSessionState
{
    public void ProcessRequest(HttpContext context)
    {
        ...
        result = list.PageQueryIncomeList("", strWhere, strOrderBy, myPageSet);    //一般查询
        list.Dispose();
