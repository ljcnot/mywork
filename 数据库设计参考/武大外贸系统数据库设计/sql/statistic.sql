...
--赖曼：使用这两句话修改表结构：
alter table totalCenter	add appDirDetail xml null
alter table totalCenter	add fundSrcDetail xml null
		...
		begin
			...
			begin
				...
				insert into #totalResult exec makeTotal @templateType, @startAcceptDate, @endAcceptDate, @startScrapDate, @endScrapDate,
												@statisticUnitType, @statisticUnitCode, @particleSize, @quotaDetail, @moneySectionDetail,
												@appDirDetail, @fundSrcDetail
				insert into subTotal(totalTabNum, RowID, eTypeCode, eTypeName, totalNum, totalMoney) 
			...
			begin
				...
				insert into #totalResult exec makeTotal @templateType, @startAcceptDate, @endAcceptDate, @startScrapDate, @endScrapDate,
												@statisticUnitType, @statisticUnitCode, @particleSize, @quotaDetail, @moneySectionDetail,
												@appDirDetail, @fundSrcDetail
				insert into subTotal(totalTabNum, RowID, clgCode, clgName, rowNum, eTypeCode, eTypeName, totalNum, totalMoney) 
				select @totalTabNum, t.* from #totalResult t
			end
			else if @particleSize = 2	--统计单位（颗粒度）:2->使用单位
			begin
				...
				insert into #totalResult exec makeTotal @templateType, @startAcceptDate, @endAcceptDate, @startScrapDate, @endScrapDate,
												@statisticUnitType, @statisticUnitCode, @particleSize, @quotaDetail, @moneySectionDetail,
												@appDirDetail, @fundSrcDetail
				insert into subTotal(totalTabNum, RowID, clgCode, clgName, uCode, uName, rowNum, eTypeCode, eTypeName, totalNum, totalMoney) 
				select @totalTabNum, t.* from #totalResult t
			end
		end
		else if @templateType = 1	--1->金额分段汇总
		begin
			...
			begin
				...
				insert into #totalResult exec makeTotal @templateType, @startAcceptDate, @endAcceptDate, @startScrapDate, @endScrapDate,
												@statisticUnitType, @statisticUnitCode, @particleSize, @quotaDetail, @moneySectionDetail,
												@appDirDetail, @fundSrcDetail
				insert into moneySectionTotal(totalTabNum, RowID, startMoney, endMoney, totalNum, totalMoney) 
				select @totalTabNum, t.* from #totalResult t
			end
			else if @particleSize = 1	--分组（统计单位或颗粒度）:1->院部
			begin
				...
				insert into #totalResult exec makeTotal @templateType, @startAcceptDate, @endAcceptDate, @startScrapDate, @endScrapDate,
												@statisticUnitType, @statisticUnitCode, @particleSize, @quotaDetail, @moneySectionDetail,
												@appDirDetail, @fundSrcDetail
				insert into moneySectionTotal(totalTabNum, RowID, clgCode, clgName, rowNum, startMoney, endMoney, totalNum, totalMoney) 
				select @totalTabNum, t.* from #totalResult t
			end
			else if @particleSize = 2	--统计单位（颗粒度）:2->使用单位
			begin
				...
				insert into #totalResult exec makeTotal @templateType, @startAcceptDate, @endAcceptDate, @startScrapDate, @endScrapDate,
												@statisticUnitType, @statisticUnitCode, @particleSize, @quotaDetail, @moneySectionDetail,
												@appDirDetail, @fundSrcDetail
				insert into moneySectionTotal(totalTabNum, RowID, clgCode, clgName, uCode, uName, rowNum, startMoney, endMoney, totalNum, totalMoney) 
				select @totalTabNum, t.* from #totalResult t
			end
		end
		else if @templateType = 2 --2->单位分组
		begin
			...
			begin
				...
				insert into #totalResult exec makeTotal @templateType, @startAcceptDate, @endAcceptDate, @startScrapDate, @endScrapDate,
												@statisticUnitType, @statisticUnitCode, @particleSize, @quotaDetail, @moneySectionDetail,
												@appDirDetail, @fundSrcDetail
				insert into unitGroupTotal(totalTabNum, RowID, clgCode, clgName, totalNum, totalMoney) 
				select @totalTabNum, t.* from #totalResult t
			end
			else if @particleSize = 2	--统计单位（颗粒度）:2->使用单位
			begin
				...
				insert into #totalResult exec makeTotal @templateType, @startAcceptDate, @endAcceptDate, @startScrapDate, @endScrapDate,
												@statisticUnitType, @statisticUnitCode, @particleSize, @quotaDetail, @moneySectionDetail,
												@appDirDetail, @fundSrcDetail
				insert into unitGroupTotal(totalTabNum, RowID, clgCode, clgName, uCode, uName, totalNum, totalMoney) 
				select @totalTabNum, t.* from #totalResult t
			end
		end
		else if @templateType = 3	--3->使用方向汇总
		begin
			...
			begin
				...
				insert into #totalResult exec makeTotal @templateType, @startAcceptDate, @endAcceptDate, @startScrapDate, @endScrapDate,
												@statisticUnitType, @statisticUnitCode, @particleSize, @quotaDetail, @moneySectionDetail,
												@appDirDetail, @fundSrcDetail
				insert into appDirTotal(totalTabNum, RowID, aCode, aName, totalNum, totalMoney) 
				select @totalTabNum, t.* from #totalResult t
			end
			else if @particleSize = 1	--分组（统计单位或颗粒度）:1->院部
			begin
				...
				insert into #totalResult exec makeTotal @templateType, @startAcceptDate, @endAcceptDate, @startScrapDate, @endScrapDate,
												@statisticUnitType, @statisticUnitCode, @particleSize, @quotaDetail, @moneySectionDetail,
												@appDirDetail, @fundSrcDetail
				insert into appDirTotal(totalTabNum, RowID, clgCode, clgName, rowNum, aCode, aName, totalNum, totalMoney) 
				select @totalTabNum, t.* from #totalResult t
			end
			else if @particleSize = 2	--统计单位（颗粒度）:2->使用单位
			begin
				...
				insert into #totalResult exec makeTotal @templateType, @startAcceptDate, @endAcceptDate, @startScrapDate, @endScrapDate,
												@statisticUnitType, @statisticUnitCode, @particleSize, @quotaDetail, @moneySectionDetail,
												@appDirDetail, @fundSrcDetail
				insert into appDirTotal(totalTabNum, RowID, clgCode, clgName, uCode, uName, rowNum, aCode, aName, totalNum, totalMoney) 
				select @totalTabNum, t.* from #totalResult t
			end
		end
		else if @templateType = 4	--4->经费来源汇总
		begin
			...
			begin
				...
				insert into #totalResult exec makeTotal @templateType, @startAcceptDate, @endAcceptDate, @startScrapDate, @endScrapDate,
												@statisticUnitType, @statisticUnitCode, @particleSize, @quotaDetail, @moneySectionDetail,
												@appDirDetail, @fundSrcDetail
				insert into fundSrcTotal(totalTabNum, RowID, fCode, fName, totalNum, totalMoney) 
				select @totalTabNum, t.* from #totalResult t
			end
			else if @particleSize = 1	--分组（统计单位或颗粒度）:1->院部
			begin
				...
				insert into #totalResult exec makeTotal @templateType, @startAcceptDate, @endAcceptDate, @startScrapDate, @endScrapDate,
												@statisticUnitType, @statisticUnitCode, @particleSize, @quotaDetail, @moneySectionDetail,
												@appDirDetail, @fundSrcDetail
				insert into fundSrcTotal(totalTabNum, RowID, clgCode, clgName, rowNum, fCode, fName, totalNum, totalMoney) 
				select @totalTabNum, t.* from #totalResult t
			end
			else if @particleSize = 2	--统计单位（颗粒度）:2->使用单位
			begin
				...
				insert into #totalResult exec makeTotal @templateType, @startAcceptDate, @endAcceptDate, @startScrapDate, @endScrapDate,
												@statisticUnitType, @statisticUnitCode, @particleSize, @quotaDetail, @moneySectionDetail,
												@appDirDetail, @fundSrcDetail
				insert into fundSrcTotal(totalTabNum, RowID, clgCode, clgName, uCode, uName, rowNum, fCode, fName, totalNum, totalMoney) 
				select @totalTabNum, t.* from #totalResult t
			end
		end
		drop table #totalResult
...
AS
	...
	begin
		if @particleSize = 0	--不分组
			set @sql = N'select ' + 'top '+ @topRows + ' RowID, eTypeCode, eTypeName, totalNum, totalMoney'
				+ ' from subTotal'
				+ ' where totalTabNum = @tabNum and RowID BETWEEN ' + str(@page * @pageSize + 1 ,10) + ' AND ' + @topRows
				+ ' order by RowID'
		else if @particleSize = 1	--分组（统计单位或颗粒度）:1->院部
			set @sql = N'select ' + 'top '+ @topRows + ' RowID, clgCode, clgName, rowNum, eTypeCode, eTypeName, totalNum, totalMoney'
				+ ' from subTotal'
				+ ' where totalTabNum = @tabNum and RowID BETWEEN ' + str(@page * @pageSize + 1 ,10) + ' AND ' + @topRows
				+ ' order by RowID'
		else if @particleSize = 2	--统计单位（颗粒度）:2->使用单位
			set @sql = N'select ' + 'top '+ @topRows + ' RowID, clgCode, clgName, uCode, uName, rowNum, eTypeCode, eTypeName, totalNum, totalMoney'
				+ ' from subTotal'
				+ ' where totalTabNum = @tabNum and RowID BETWEEN ' + str(@page * @pageSize + 1 ,10) + ' AND ' + @topRows
				+ ' order by RowID'
	...
	begin
		if @particleSize = 0	--不分组
			set @sql = N'select ' + 'top '+ @topRows + ' RowID, startMoney, endMoney, totalNum, totalMoney'
				+ ' from moneySectionTotal'
				+ ' where totalTabNum = @tabNum and RowID BETWEEN ' + str(@page * @pageSize + 1 ,10) + ' AND ' + @topRows
				+ ' order by RowID'
		else if @particleSize = 1	--分组（统计单位或颗粒度）:1->院部
			set @sql = N'select ' + 'top '+ @topRows + ' RowID, clgCode, clgName, rowNum, startMoney, endMoney, totalNum, totalMoney'
				+ ' from moneySectionTotal'
				+ ' where totalTabNum = @tabNum and RowID BETWEEN ' + str(@page * @pageSize + 1 ,10) + ' AND ' + @topRows
				+ ' order by RowID'
		else if @particleSize = 2	--统计单位（颗粒度）:2->使用单位
			set @sql = N'select ' + 'top '+ @topRows + ' RowID, clgCode, clgName, uCode, uName, rowNum, startMoney, endMoney, totalNum, totalMoney'
				+ ' from moneySectionTotal'
				+ ' where totalTabNum = @tabNum and RowID BETWEEN ' + str(@page * @pageSize + 1 ,10) + ' AND ' + @topRows
				+ ' order by RowID'
	...
	begin
		if @particleSize = 1	--分组（统计单位或颗粒度）:1->院部
			set @sql = N'select ' + 'top '+ @topRows + ' RowID, clgCode, clgName, totalNum, totalMoney'
				+ ' from unitGroupTotal'
				+ ' where totalTabNum = @tabNum and RowID BETWEEN ' + str(@page * @pageSize + 1 ,10) + ' AND ' + @topRows
				+ ' order by RowID'
		else if @particleSize = 2	--统计单位（颗粒度）:2->使用单位
			set @sql = N'select ' + 'top '+ @topRows + ' RowID, clgCode, clgName, uCode, uName, totalNum, totalMoney'
				+ ' from unitGroupTotal'
				+ ' where totalTabNum = @tabNum and RowID BETWEEN ' + str(@page * @pageSize + 1 ,10) + ' AND ' + @topRows
				+ ' order by RowID'
	...
	begin
		if @particleSize = 0	--不分组
			set @sql = N'select ' + 'top '+ @topRows + ' RowID, aCode, aName, totalNum, totalMoney'
				+ ' from appDirTotal'
				+ ' where totalTabNum = @tabNum and RowID BETWEEN ' + str(@page * @pageSize + 1 ,10) + ' AND ' + @topRows
				+ ' order by RowID'
		else if @particleSize = 1	--分组（统计单位或颗粒度）:1->院部
			set @sql = N'select ' + 'top '+ @topRows + ' RowID, clgCode, clgName, rowNum, aCode, aName, totalNum, totalMoney'
				+ ' from appDirTotal'
				+ ' where totalTabNum = @tabNum and RowID BETWEEN ' + str(@page * @pageSize + 1 ,10) + ' AND ' + @topRows
				+ ' order by RowID'
		else if @particleSize = 2	--统计单位（颗粒度）:2->使用单位
			set @sql = N'select ' + 'top '+ @topRows + ' RowID, clgCode, clgName, uCode, uName, rowNum, aCode, aName, totalNum, totalMoney'
				+ ' from appDirTotal'
				+ ' where totalTabNum = @tabNum and RowID BETWEEN ' + str(@page * @pageSize + 1 ,10) + ' AND ' + @topRows
				+ ' order by RowID'
	...
	begin
		if @particleSize = 0	--不分组
			set @sql = N'select ' + 'top '+ @topRows + ' RowID, fCode, fName, totalNum, totalMoney'
				+ ' from fundSrcTotal'
				+ ' where totalTabNum = @tabNum and RowID BETWEEN ' + str(@page * @pageSize + 1 ,10) + ' AND ' + @topRows
				+ ' order by RowID'
		else if @particleSize = 1	--分组（统计单位或颗粒度）:1->院部
			set @sql = N'select ' + 'top '+ @topRows + ' RowID, clgCode, clgName, rowNum, fCode, fName, totalNum, totalMoney'
				+ ' from fundSrcTotal'
				+ ' where totalTabNum = @tabNum and RowID BETWEEN ' + str(@page * @pageSize + 1 ,10) + ' AND ' + @topRows
				+ ' order by RowID'
		else if @particleSize = 2	--统计单位（颗粒度）:2->使用单位
			set @sql = N'select ' + 'top '+ @topRows + ' RowID, clgCode, clgName, uCode, uName, rowNum, fCode, fName, totalNum, totalMoney'
				+ ' from fundSrcTotal'
				+ ' where totalTabNum = @tabNum and RowID BETWEEN ' + str(@page * @pageSize + 1 ,10) + ' AND ' + @topRows
				+ ' order by RowID'
	...
	set @pages = (@rows + @pageSize -1) / @pageSize	--总页数
--print @sql
	EXECUTE sp_executesql @sql, N'@tabNum varchar(20)', @tabNum=@totalTabNum
GO
--测试：
use epdc2
select * from totalCenter
...
declare @rows int, @pages int
exec dbo.getTotalResult '201103120006', 20, 0, @rows output, @pages output
select @rows, @pages
