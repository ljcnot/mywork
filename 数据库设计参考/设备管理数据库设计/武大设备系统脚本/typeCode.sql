...
--2013-10-29根据武大设备处增加的分类编码：
select * from typeCodes where eTypeCode='05010105'
insert typeCodes(eKind,eClass,eSubClass,eTypeCode,eTypeName,aTypeCode,aTypeName, cssName)
select top 1 eKind,eClass,eSubClass,eTypeCode,'平板电脑（Pad）',aTypeCode,aTypeName, cssName 
from typeCodes where eTypeCode='05010105'

insert typeCodes(eKind,eClass,eSubClass,eTypeCode,eTypeName,aTypeCode,aTypeName, cssName)
select top 1 eKind,eClass,eSubClass,eTypeCode,'智能电视（可联网）',aTypeCode,aTypeName, cssName 
from typeCodes where eTypeCode='05010105'
...
insert kindTypeCodes(eKind, eTypeCode, eTypeName, aTypeCode, aTypeName, include, inputCode, remark,cssName)
select eKind, eTypeCode, eTypeName, aTypeCode, aTypeName, include, inputCode, remark,cssName from WHGXYepdc211.dbo.kindTypeCodes

insert classTypeCodes(eKind, eClass, eTypeCode,eTypeName,aTypeCode,aTypeName,inputCode,remark,cssName)
select eKind, eClass, eTypeCode,eTypeName,aTypeCode,aTypeName,inputCode,remark,cssName from WHGXYepdc211.dbo.classTypeCodes

insert subClassTypeCodes(eKind, eClass, eSubClass,eTypeCode,eTypeName,aTypeCode,aTypeName,inputCode,remark,cssName)
select eKind, eClass, eSubClass,eTypeCode,eTypeName,aTypeCode,aTypeName,inputCode,remark,cssName from WHGXYepdc211.dbo.subClassTypeCodes

insert typeCodes(eKind, eClass, eSubClass, eTypeCode, eTypeName, aTypeCode, aTypeName, inputCode, remark, cssName)
select eKind, eClass, eSubClass, eTypeCode, eTypeName, aTypeCode, aTypeName, inputCode, remark, cssName from WHGXYepdc211.dbo.typeCodes
