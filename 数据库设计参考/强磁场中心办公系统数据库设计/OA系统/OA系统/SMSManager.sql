...
*/
select * from SMSInfo where smsInfoID = '201307150018' order by SMSStatus 
update SMSInfo 
set SMSStatus = 0
where smsInfoID = '201307150018'

--1.短信管理表：
drop TABLE SMSInfo
CREATE TABLE SMSInfo
(
	SMSInfoID char(12) not null,		--主键：短信标识，使用第 10020号号码发生器产生
	...
	sendTime datetime null,				--实际发送时间
	SMSType smallint default(2),		--短信类型：1->系统定期推送、2->手工发送、9->系统管理类短信
...
exec addSMSInfo '00200977','00200977,00001','18602702392,13329723988','',2,'Hello world!','00200977',@Ret output, @createTime output, @SMSInfoID output
select @Ret,@SMSInfoID

select * from SMSInfo
where SMSInfoID='201303160001'
