...
alter TABLE eqpPlanInfo add createManID varchar(10) null		--创建人工号
alter TABLE eqpPlanInfo add createManName varchar(30) null		--创建人姓名
alter TABLE eqpPlanInfo add createTime smalldatetime null		--创建时间
alter TABLE eqpPlanInfo add clgManagerID varchar(10) null		--单位负责人工号 add by lw 2012-8-15
alter TABLE eqpPlanInfo add leaderID varchar(10) null			--校领导工号 add by lw 2012-8-15
