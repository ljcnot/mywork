...
customerID	varchar(10)	not null,	--客户ID
...
/*
	...
	input: 
				...
				@contractAmount numeric(15,2),	--合同金额
				@receivedAmount	numeric(15,2),	--已收金额
				@remarks	varchar(200),	--备注
...
create PROCEDURE addIncome
				@incomeInformationID varchar(16),	--收入记录号
				@projectID	varchar(13),	--项目ID
				@project		varchar(50),		--项目名称
...
contractAmount numeric(15,2) ,	--合同金额
receivedAmount numeric(15,2),	--已付金额
remarks	varchar(200),	--备注
